...
import com.fbq.baseadmin.util.ErrorUtil;
import com.fbq.baseadmin.limiter.RateLimiter;
...
public class OpenApiAspect {
    ...
    /**
     * Pointcut 切入点
     * 匹配 com.fbq.baseadmin.openapi.controller 包下面的所有方法
     */
    @Pointcut(value = "execution(public * com.fbq.baseadmin.openapi.controller.*.*(..))")
