package com.fbq.baseadmin.aspect;
...
public class SafetyAspect {
     ...
     * Pointcut 切入点
     * 匹配
     * com.fbq.baseadmin.sys.*.controller、
     * com.fbq.baseadmin.*.controller包下面的所有方法
     */
    @Pointcut(value = "execution(public * com.fbq.baseadmin.sys.*.controller.*.*(..)) || " +
            "execution(public * com.fbq.baseadmin.*.controller.*.*(..))")
